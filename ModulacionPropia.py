...
import ModulacionPropia_epy_block_0 as epy_block_0  # embedded python block
import ModulacionPropia_epy_block_1 as epy_block_1  # embedded python block
import math
...
class ModulacionPropia(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPropia")
        ...
        self.qtgui_const_sink_x_0_0.set_y_axis(-6, 6)
        self.qtgui_const_sink_x_0_0.set_x_axis(-6, 6)
        ...
        self.qtgui_const_sink_x_0.set_y_axis(-6, 6)
        self.qtgui_const_sink_x_0.set_x_axis(-6, 6)
        ...
        self.epy_block_1 = epy_block_1.QPSKModulator()
        self.epy_block_0 = epy_block_0.blk(example_param=1.0)
        self.blocks_vector_source_x_0 = blocks.vector_source_b((1,1,0,0,1,0,0,1), True, 1, [])
        ...
        self.connect((self.blocks_add_const_vxx_0, 0), (self.epy_block_0, 0))
        ...
        self.connect((self.epy_block_1, 0), (self.interp_fir_filter_xxx_0_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
...
def main(top_block_cls=ModulacionPropia, options=None):
