...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(fc*2, analog.GR_COS_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(fc*2, analog.GR_COS_WAVE, fc, 1, 0, 0)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.analog_sig_source_x_0.set_sampling_freq(self.fc*2)
        self.analog_sig_source_x_0.set_frequency(self.fc)
        self.analog_sig_source_x_0_0.set_sampling_freq(self.fc*2)
        self.analog_sig_source_x_0_0.set_frequency(self.fc)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.fc, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.fc*10)
