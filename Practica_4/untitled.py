...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Ejemplo1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ejemplo1")
        ...
        self.Rs = Rs = 32000
        self.M = M = 4
        self.tabla_de_verdad = tabla_de_verdad = (1+0j,0-1j, -1+0j, 0+1j)
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(tabla_de_verdad, 1)
    ...
    def get_tabla_de_verdad(self):
        return self.tabla_de_verdad

    def set_tabla_de_verdad(self, tabla_de_verdad):
        self.tabla_de_verdad = tabla_de_verdad
        self.digital_chunks_to_symbols_xx_0.set_symbol_table(self.tabla_de_verdad)
