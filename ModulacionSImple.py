...
class ModulacionSImple(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionSImple")
        ...
        self.sps = sps = len(h)
        self.bps = bps = int(math.log(M_niveles,2))
        self.Rs = Rs = 32e3
    ...
    def set_Constelacion(self, Constelacion):
        ...
        self.set_M_niveles(len(self.Constelacion))
    ...
    def get_M_niveles(self):
        return self.M_niveles

    def set_M_niveles(self, M_niveles):
        self.M_niveles = M_niveles
        self.set_bps(int(math.log(self.M_niveles,2)))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_samp_rate(32000*self.sps)
...
def main(top_block_cls=ModulacionSImple, options=None):
