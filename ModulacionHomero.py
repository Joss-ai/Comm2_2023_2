...
import ModulacionHomero_epy_block_0 as epy_block_0  # embedded python block
import math
...
class ModulacionHomero(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionHomero")
        ...
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(math.pi/M)
    ...
    def set_M(self, M):
        ...
        self.blocks_add_const_vxx_0.set_k(math.pi/self.M)
    ...
    def set_Rs(self, Rs):
        self.Rs = Rs
        self.set_Samp_rate(self.Rs*self.Sps)
        self.qtgui_time_sink_x_0.set_samp_rate(self.Rs*6)
...
def main(top_block_cls=ModulacionHomero, options=None):
